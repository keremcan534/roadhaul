...
export const ASPHALT: Surface = Object.freeze({ name: 'asphalt', gripFactor: 1, rollingResistance: 0.009 });

/** Off-road: slippery and slow (tops out well below highway speed), so leaving the road is noticeable but not a trap. */
export const GRASS: Surface = Object.freeze({ name: 'grass', gripFactor: 0.6, rollingResistance: 0.12 });
