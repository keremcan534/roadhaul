...
| RoadFurnitureView | presentation | `src/presentation/world/RoadFurnitureView.ts` | Delineator posts along the country roads and the highway, their amber reflectors shining in the truck's headlights at night; the world's guard rails in galvanised steel that mirrors the sky; two instanced draw calls and one per 600 m rail tile | DrivingWorld (read only), three | none |
